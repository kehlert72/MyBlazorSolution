...
using MyBlazorSolution.Blazor.Server.Services;

namespace MyBlazorSolution.Blazor.Server {
    public partial class MyBlazorSolutionBlazorApplication : BlazorApplication {
        public MyBlazorSolutionBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void MyBlazorSolutionBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
